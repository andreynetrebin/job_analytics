...
- Организация структуры проекта.
    - Логика работы с базой выделена в директорию 'database'.
    - Вспомогательные утилиты в директорию 'utils'.
- Обновлена логика обработки в REST API:
    - get_average_salaries добавлено в разрезе опыта работы.
    - get_vacancies_by_professional_role в результате возвращается топ-10.
    - get_industries в результате возвращается топ-10.
    - get_vacancies_status_trends возвращает динамику изменения статусов вакансий.
- Исправлен дубляж записей при переводе вакансии в статус "Архивный"
...
- Обновлена логика обработки в REST API:
    - get_vacancies_status_trends разделена на два по одному на каждый статус.
    - get_employer_accreditation_count возвращает количество уникальных работодателей с IT-акредитацией и без нее.

## [1.21.0] - 2025-08-07

### Изменения

- Добавлены несколько endpoint'ов:
    - get_top_cities возвращает топ-10 регионов работодателей по количеству вакансий по заданному поисковому запросу.
    - get_employer_count возвращает количество работодателей с активными вакансиями по заданному поисковому запросу.
    - get_vacancy_count Возвращает количество активных и архивных вакансий по заданному поисковому запросу.